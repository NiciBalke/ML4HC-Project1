...
pathToData = "ml4h_data/p1//set-c"
#pathToOutcomes = "ml4h_data/p1/outcomes-a.txt"
all_data = []
counter = 0
...
output_path = "pData-c.parquet"
if(os.path.exists(output_path)):
    shutil.rmtree(output_path)

full_df.to_parquet(output_path, engine="pyarrow", index=False, partition_cols = ["RecordID"])
